...
#1. Basic User
#2. Super User
    def create_user(self,first_name, last_name,username,email,password=None): #jehetu class ar under a function tai first parameter ta self e hobe
        if not email:
...
class UserProfile(models.Model):
    user = OneToOneField(User, on_delete=models.CASCADE, blank=True, null=True) #Jate one user multiple account na hoye
